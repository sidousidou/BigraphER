...
let r_test = Brs.parse_react_unsafe ~name:"" ~lhs:big_test ~rhs:big_test None
...
let () =
  ...
  print_endline
  @@ test big_test big_to_json big_of_json Big.equal Big.to_string;
  ...
  print_endline @@ step ~minify:false
