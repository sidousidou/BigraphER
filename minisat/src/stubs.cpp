...
CAMLprim value ocaml_minisat_add_caluse_empty (value solver);
CAMLprim value ocaml_minisat_add_clause_unit (value solver, value l);
CAMLprim value ocaml_minisat_add_clause_binary (value solver, value l0, value l1);
CAMLprim value ocaml_minisat_add_clasue_ternary (value solver, value l0, value l1, value l2);
CAMLprim value ocaml_minisat_add_clause_quaternary (value solver,value l0, value l1, value l2, value l3);
...
CAMLprim value ocaml_minisat_new(value unit) {
  ...
  result = caml_alloc_custom(&minisat_ops, sizeof(Solver *), 1024 * 1024,
                             50 * 1024 * 1024);
