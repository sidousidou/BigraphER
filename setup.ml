...
(* OASIS_START *)
(* DO NOT EDIT (digest: e85eb157097442d0c28418b40c18423a) *)
(*
...
let setup_t =
  {
            ...
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args =
                   [
                      "-use-ocamlfind";
                      "-docflags '-t Bigraph -colorize-code -short-functors -show-missed-crossref -charset utf-8'"
                   ];
                 run_path = "lib"
              })
       ];
     ...
     oasis_digest = Some "\227\142~GX\165y\236\155\216\154\1438\184\200\128";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
