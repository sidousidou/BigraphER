...
(* OASIS_START *)
(* DO NOT EDIT (digest: d08f49099fdec8ce48956366f3f45853) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "BigraphER is an efficient implementation of Bigraphical Reactive Systems (BRS) that supports bigraphs with sharing, stochastic and probabilistic reaction rules, rule priorities, graphical output and predicate checking. Models can be exported to probabilistic model checker PRISM."
              ];
          tags = [];
          categories = [];
          files_ab =
     ...
     oasis_digest = Some "\145\184\213i\006WR\021\240\151L\236&\217\192`";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
