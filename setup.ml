...
(* OASIS_START *)
(* DO NOT EDIT (digest: 29fafc63e0f507a4cd62b1c93d7d300c) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("native-link",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./ex.native", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ex.ml"});
               Test
                 ({
                     cs_name = "byte-link";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "å \000\027æ\143°gmJ\020\129\bF¹.";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
