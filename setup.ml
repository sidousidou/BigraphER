...
(* OASIS_START *)
(* DO NOT EDIT (digest: 51b76cf0e0d98d4f3b11edb5ddcfa422) *)
(*
...
let setup_t =
  {
                 ...
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("./test_match.native",
                          ["./tests/files/match/"; "./shippable/testresults"]))
                   ];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "bin";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "bigraph-utils"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "menhir"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\233E\224\172\225\151?<\178\024,\031\220-\220F";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
