...
(* OASIS_START *)
(* DO NOT EDIT (digest: b9a9e0552ef47e0cd3dc2d92bad56f9b) *)
(*
...
let setup_t =
  {
     ...
     oasis_digest = Some "3_\029\128\181Wi\031\2278\239\193P18\140";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
