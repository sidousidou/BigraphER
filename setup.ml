...
(* OASIS_START *)
(* DO NOT EDIT (digest: 41579268fde317eadc2feea06c67bd9e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          files_ab = ["bin/cmd.ml.ab"; "man/bigrapher.1.ab"];
          sections =
            [
               Library
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\182E\000\218\019\204vZP;D\169\164\158\239\205";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
