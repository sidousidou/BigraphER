...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3a59f4cf19cf54f332704baeb24d71a1) *)
(*
...
let setup_t =
  {
     ...
     build = OCamlbuildPlugin.build ["-use-ocamlfind"; "-j"; "4"];
     test =
       [
          ("matching",
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("./test_brs.native",
                          ["./shippable/testresults"; "brs-junit.xml"]))
                   ];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
            ...
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args =
                   [
                      "-use-ocamlfind";
                      "-docflags '-t Bigraph -colorize-code -short-functors -charset utf-8'"
                   ];
                 run_path = "lib"
              })
       ];
     ...
     package =
       {
          ...
          license_file = Some "LICENSE.md";
          copyrights = [];
          maintainers =
            ["Michele Sevegnani <Michele.Sevegnani@glasgow.ac.uk>"];
          authors = ["Michele Sevegnani"];
          homepage = Some "http://www.dcs.gla.ac.uk/~michele/bigrapher.html";
          synopsis = "Implementation of bigraphical reactive systems";
          description =
            Some
              [
                 OASISText.Para
                   "BigraphER is an efficient implementation of Bigraphical Reactive Systems (BRS) that supports bigraphs with sharing, stochastic reaction rules, rule priorities, graphical output and predicate checking. Models can be exported to probabilistic model checker PRISM.";
                 OASISText.BlankLine
              ];
          categories = [];
          ...
          files_ab =
            [
               "bin/version.ml.ab";
               "man/bigrapher.1.ab";
               "man/bigrapher-validate.1.ab";
               "man/bigrapher-full.1.ab";
               "man/bigrapher-sim.1.ab";
               "opam/opam.ab";
               "README.md.ab";
               "Makefile.config.ab"
            ];
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_byteopt = [(OASISExpr.EBool true, ["-noassert"])];
                      bs_nativeopt = [(OASISExpr.EBool true, ["-noassert"])]
                   },
                   {
                      lib_modules =
                        [
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "lib";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "bigraph"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "menhir"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "rpo.ml"});
               Library
                 ({
                     cs_name = "bigraph-utils";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "bigraph";
                           InternalLibrary "bigrapher-utils"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "menhir"];
                      bs_c_sources = [];
                   ...
                   {exec_custom = false; exec_main_is = "bigrapher.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://mseve@bitbucket.org/mseve/bigrapher.git";
                      src_repo_browser =
                        Some "https://bitbucket.org/mseve/bigrapher";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for bigraph library";
                      doc_authors = ["Michele Sevegnani"];
                      doc_abstract =
                        Some
                          "API reference for library [bigraph]. It provides modules for:\n * manipulation of place graphs link graphs and bigraphs with sharing,\n * definition of (stochastic) reaction rules with support for instantiation maps,\n * full generation of the state space and simulation of (stochastic) bigraphical\n   reactive systems with rule priorities.";
                      doc_format = HTML "API.html";
                      doc_data_files = [];
                      doc_build_tools =
                        [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_match.ml"});
               Test
                 ({
                     cs_name = "matching";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_brs.ml"});
               Test
                 ({
                     cs_name = "brs";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_decomp.ml"});
               Test
                 ({
                     cs_name = "decomp";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "cobertura.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "i:~Y\236\129\195/\025H\029\215\003s\172\234";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
