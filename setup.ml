...
(* OASIS_START *)
(* DO NOT EDIT (digest: f68531d1ecb4421ab38c8a6029a271a5) *)
(*
...
let setup_t =
  {
       ...
       [
                 ...
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("../test_match.native", ["match"; "./files/match/"]))
                   ];
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("../test_decomp.native", ["./files/match/"]))
                   ];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("brs-brs",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./test_brs.native", ["brs"]))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("brs-sym-brs",
          ...
          ("brs-sbrs",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./test_brs.native", ["sbrs"]))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("brs-sym-sbrs",
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build bigrapher without Graphviz support";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "k\011*a\133ìÈ¬7þ\155\146\007e/*";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
