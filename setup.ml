...
(* OASIS_START *)
(* DO NOT EDIT (digest: 193113d5042f34a2799ed22001ee0890) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_rpo.ml"});
               Test
                 ({
                     cs_name = "rpo";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\176\187$PX\155\192\154i\024\230W\2129lT";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
